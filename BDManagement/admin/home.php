            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" method="post" action="home.php">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6"> <input type="text" name="firstName" class="form-control" placeholder="First Name" required="true"> </div>
                        <div class="col-sm-6"><input type="text" name="middleName" class="form-control" placeholder="Middle Name"></div>
                        <div class="col-sm-6"><input type="text" name="lastName" class="form-control" placeholder="Last Name" required="true"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-danger btn-outline btn-md" name="submit">Add Employee</button>
                    </div>
                </form>
            </div>
        </div>
